      ...
      <div className="w-full max-w-sm" style={{ position: 'relative', zIndex: 1, animation: 'fadeUp 0.5s ease both' }}>
        ...
        <div style={{
          ...
          <div className="space-y-3 mb-4">
            ...
            >
              <Github size={18} />
              <span className="text-sm font-medium" style={{ color: 'var(--color-text-primary)' }}>Continue with GitHub</span>
            </button>
            ...
            >
              ...
              <span className="text-sm font-medium text-white">Continue with LinkedIn</span>
            </button>
            ...
            >
              ...
              <span className="text-sm font-medium" style={{ color: 'var(--color-text-primary)' }}>Continue with Google</span>
            </button>
          </div>
